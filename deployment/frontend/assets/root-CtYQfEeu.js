...
import {
  ...
  x as b,
  y as x,
} from "./esm-DBYpp4Gr.js";
import { t as S } from "./reflex-env-irNVy4st.js";
import {
  n as C,
  r as w,
  t as T,
...
var E = t(o(), 1),
  ...
  k = class extends E.Component {
    ...
    componentDidUpdate(e, t) {
      ...
      if (n && t.error !== null && A(e.resetKeys, r)) {
        var i, a;
    ...
    render() {
      ...
      if (i) {
        ...
        else if (n) o = (0, E.createElement)(n, e);
...
function M({ children: e, defaultTheme: t = `system` }) {
  let [n, r] = (0, E.useState)(t),
    [i, a] = (0, E.useState)(t === `system` ? `light` : t),
    [o, s] = (0, E.useState)(!1),
    c = (0, E.useRef)(!0);
  (0, E.useEffect)(() => {
    c.current &&
  ...
  let l = (0, E.useMemo)(() => (n === `system` ? i : n), [n, i]);
  return (
    (0, E.useEffect)(() => {
...
function N() {
  return (0, E.useContext)(j);
}
function P({ children: e }) {
  let { theme: t, resolvedTheme: n, setTheme: r } = N();
  return (
    (0, E.useEffect)(() => {
        ...
        value: {
          ...
          setColorMode: (e) => {
            ([`light`, `dark`, `system`].includes(e) ||
              (console.error(
                `Invalid color mode "${e}". Defaulting to "${x}".`,
              ),
              (e = x)),
              r(e));
          },
  ...
  B = new (class {
    constructor() {
      ((this.subscribe = (e) => (
        ...
        (this.create = (e) => {
          let { message: t, ...n } = e,
            r = typeof e?.id == `number` || e.id?.length > 0 ? e.id : z++,
        ...
        (this.promise = (e, t) => {
          ...
          let r = Promise.resolve(e instanceof Function ? e() : e),
            ...
            o = r
              .then(async (e) => {
                if (((a = [`resolve`, e]), E.isValidElement(e)))
                  ((i = !1),
                  ...
                  let r =
                    ...
                    a =
                      typeof t.description == `function`
                        ...
                        : t.description,
                    o =
                      typeof r == `object` && !E.isValidElement(r)
                        ? r
                        : { message: r };
...
var ye = (e) => {
  let {
    ...
    G = E.useMemo(() => s.findIndex((e) => e.toastId === n.id) || 0, [s, n.id]),
    he = E.useMemo(() => n.closeButton ?? f, [n.closeButton, f]),
    ye = E.useMemo(() => n.duration || g || me, [n.duration, g]),
    q = E.useRef(0),
    J = E.useRef(0),
    be = E.useRef(0),
    Y = E.useRef(null),
  ...
  function we() {
    return x?.loading
      ? E.createElement(
          `div`,
          {
            className: K(b?.loader, n?.classNames?.loader, `sonner-loader`),
            "data-visible": H === `loading`,
          },
          x.loading,
        )
      : E.createElement(ae, {
          className: K(b?.loader, n?.classNames?.loader),
          visible: H === `loading`,
        });
  }
  let Te = n.icon || x?.[H] || ie(H);
  return E.createElement(
    `li`,
    {
      ...
      "data-sonner-toast": ``,
      "data-rich-colors": n.richColors ?? ee,
      ...
      style: {
        ...
        "--toasts-before": c,
        "--z-index": l.length - c,
        "--offset": `${A ? oe : J.current}px`,
        "--initial-height": y ? `auto` : `${se}px`,
        ...te,
        ...n.style,
      },
      onDragEnd: () => {
        (N(!1), w(null), (Y.current = null));
      },
      onPointerDown: (e) => {
        e.button !== 2 &&
          (Q ||
            ...
            e.target.tagName !== `BUTTON` &&
              (N(!0), (Y.current = { x: e.clientX, y: e.clientY }))));
      },
      onPointerUp: () => {
        if (P || !W) return;
        Y.current = null;
        let e = Number(
          ...
          i = C === `x` ? e : t,
          a = Math.abs(i) / r;
        if (Math.abs(i) >= ge || a > 0.11) {
          (L(J.current),
            n.onDismiss == null || n.onDismiss.call(n, n),
            D(C === `x` ? (e > 0 ? `right` : `left`) : t > 0 ? `down` : `up`),
            $(),
            re(!0));
          return;
        } else {
      ...
      onPointerMove: (t) => {
        var n, r;
        if (!Y.current || !W || window.getSelection()?.toString().length > 0)
          return;
        let i = t.clientY - Y.current.y,
          a = t.clientX - Y.current.x,
          o = e.swipeDirections ?? ve(_);
        !C &&
          (Math.abs(a) > 1 || Math.abs(i) > 1) &&
          w(Math.abs(a) > Math.abs(i) ? `x` : `y`);
        let s = { x: 0, y: 0 },
        ...
        } else if (C === `x` && (o.includes(`left`) || o.includes(`right`)))
    ...
    he && !n.jsx && H !== `loading`
      ? E.createElement(
          `button`,
          {
            ...
            className: K(b?.closeButton, n?.classNames?.closeButton),
          },
          x?.close ?? ce,
        )
      : null,
    (H || n.icon || n.promise) && n.icon !== null && (x?.[H] !== null || n.icon)
      ? E.createElement(
          `div`,
          { "data-icon": ``, className: K(b?.icon, n?.classNames?.icon) },
    ...
    E.createElement(
      `div`,
      { "data-content": ``, className: K(b?.content, n?.classNames?.content) },
      E.createElement(
        `div`,
        { "data-title": ``, className: K(b?.title, n?.classNames?.title) },
      ...
      n.description
        ? E.createElement(
            ...
            {
              "data-description": ``,
              className: K(h, pe, b?.description, n?.classNames?.description),
            },
      ...
      : n.cancel && U(n.cancel)
        ? E.createElement(
            `button`,
            {
              ...
              className: K(b?.cancelButton, n?.classNames?.cancelButton),
            },
            n.cancel.label,
          )
        : null,
    E.isValidElement(n.action)
      ? n.action
      : n.action && U(n.action)
        ? E.createElement(
            `button`,
            {
              ...
              className: K(b?.actionButton, n?.classNames?.actionButton),
            },
            n.action.label,
          )
        : null,
...
var be = E.forwardRef(function (e, t) {
    let {
        id: n,
        invert: r,
      ...
      b = E.useMemo(
        () =>
          n
            ? v.filter((e) => e.toasterId === n)
            : v.filter((e) => !e.toasterId),
        [v, n],
      ),
      x = E.useMemo(
        () =>
          Array.from(
            new Set(
              [i].concat(b.filter((e) => e.position).map((e) => e.position)),
            ),
          ),
        [b, i],
      ),
          ...
          return b.length
            ? E.createElement(
                `ol`,
                {
                  ...
                  "data-x-position": a,
                  style: {
                    "--front-toast-height": `${S[0]?.height || 0}px`,
                    "--width": `${G}px`,
                    "--gap": `${h}px`,
                    ...te,
                    ...J(l, u),
                  ...
                  onBlur: (e) => {
                    P.current &&
                      ...
                      ((P.current = !1),
                      (N.current &&=
                        (N.current.focus({ preventScroll: !0 }), null)));
                  },
                  onFocus: (e) => {
                    (e.target instanceof HTMLElement &&
                      e.target.dataset.dismissible === `false`) ||
                      P.current ||
                      ((P.current = !0), (N.current = e.relatedTarget));
                  },
                  onMouseEnter: () => T(!0),
                  onMouseMove: () => T(!0),
                  onMouseLeave: () => {
                ...
                b
                  ...
                  .map((n, i) =>
                    E.createElement(ye, {
                      ...
                      removeToast: F,
                      toasts: b.filter((e) => e.position == n.position),
                      heights: S.filter((e) => e.position == n.position),
                      setHeights: C,
                      expandByDefault: o,
                      gap: h,
                      expanded: w,
  ...
  xe = e(
    { DefaultOverlayComponents: () => X, MemoizedToastProvider: () => Se },
    1,
  );
const Se = (0, E.memo)(({}) => {
    let { resolvedColorMode: e } = (0, E.useContext)(m);
    return (
      (d.__toast = H),
      C(be, {
        closeButton: !1,
...
var Z = {
  ...
  Ce = `/assets/__reflex_global_styles-oJb4uY93.css`;
...
`,
      ...
      C(r, {}),
      C(`link`, { href: Ce, rel: `stylesheet`, type: `text/css` }),
      C(a, {}),
    ),
    C(`body`, {}, e, C(i, {}), C(l, {})),
  );
            ...
            C(
              ...
              C(
                ...
                C(
                  ...
                  C(`path`, { d: `M16 16s-1.5-2-4-2-4 2-4 2` }),
                  C(`line`, { x1: `9`, x2: `9.01`, y1: `9`, y2: `9` }),
                  C(`line`, { x1: `15`, x2: `15.01`, y1: `9`, y2: `9` }),
                ),
                C(
                  `h2`,
...
` +
      ...
      C(
        ...
        C(
          ...
          C(
            _,
            { css: { ...Z.styles.global[`:root`], ...Z.styles.global.body } },
            C(E.Fragment, {}, C(X, {}), C(E.Fragment, {}, e)),
          ),
        ),
      ),
    ),
...
function we({ children: e }) {
  return (
    ...
    C(
      ...
      C(
        M,
        { defaultTheme: x, attribute: `class` },
        C(f, {}, C(ne, {}, C($, {}, e))),
      ),
    )
  );
...
export { we as Layout, Te as default };
