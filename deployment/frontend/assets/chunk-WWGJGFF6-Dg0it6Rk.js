import { r as e, t } from "./rolldown-runtime-CkEfyhlV.js";
var n = t((e) => {
...
function h(e, t, n = null, r) {
  return {
    ...
    search: ``,
    hash: ``,
    ...(typeof t == `string` ? _(t) : t),
    state: n,
    key: (t && t.key) || r || p(),
  };
}
function g({ pathname: e = `/`, search: t = ``, hash: n = `` }) {
  return (
...
function v(e, t, n, r = {}) {
  let { window: i = document.defaultView, v5Compat: a = !1 } = r,
    ...
    c = null,
    u = d();
  u ?? ((u = 0), o.replaceState({ ...o.state, idx: u }, ``));
  function d() {
  ...
  function f() {
    ...
    let e = d(),
      t = e == null ? null : e - u;
    ((u = e), c && c({ action: s, location: v.location, delta: t }));
  }
  function p(e, t) {
    s = `PUSH`;
    ...
    a && c && c({ action: s, location: v.location, delta: 1 });
  }
  function g(e, t) {
    s = `REPLACE`;
    let r = h(v.location, e, t);
    ...
    let i = m(r, u),
      l = v.createHref(r);
    (o.replaceState(i, ``, l),
      a && c && c({ action: s, location: v.location, delta: 0 }));
  }
  function _(e) {
    return y(e);
  }
  let v = {
    ...
    listen(e) {
      ...
      return (
        ...
        (c = e),
        () => {
          (i.removeEventListener(l, f), (c = null));
        }
      );
    },
    createHref(e) {
...
var x,
  S = class {
    constructor(e) {
      if ((c(this, x, new Map()), e)) for (let [t, n] of e) this.set(t, n);
    }
    get(e) {
...
function O(e, t, n = [], r = {}, i = !1) {
  return e.map((e, a) => {
    ...
    if (
      ...
      let n = { ...e, id: s };
      return ((r[s] = k(n, t(n))), n);
    } else {
      let n = { ...e, id: s, children: void 0 };
      return (
        (r[s] = k(n, t(n))),
        e.children && (n.children = O(e.children, t, o, r, i)),
        n
      );
    }
  });
...
function j(e, t, n, r) {
  let i = B((typeof t == `string` ? _(t) : t).pathname || `/`, n);
...
function M(e, t = [], n = [], r = ``, i = !1) {
  let a = (e, a, o = i, s) => {
    ...
    (e.children &&
      ...
      M(e.children, t, u, l, o)),
      !(e.path == null && !e.index) &&
        t.push({ path: l, score: L(l, e.index), routesMeta: u }));
  };
  return (
    e.forEach((e, t) => {
      if (e.path === `` || !e.path?.includes(`?`)) a(e, t);
      else for (let n of N(e.path)) a(e, t, !0, n);
    }),
    t
  );
}
...
function L(e, t) {
  ...
  return (
    ...
    n
      .filter((e) => !ae(e))
      .reduce((e, t) => e + (P.test(t) ? F : t === `` ? I : re), r)
  );
}
function oe(e, t) {
  ...
  for (let e = 0; e < r.length; ++e) {
    ...
    (Object.assign(i, u.params),
      o.push({
        ...
        pathnameBase: _e(H([a, u.pathnameBase])),
        route: d,
      }),
...
function le({ basename: e, pathname: t }) {
  return t === `/` ? e : H([e, t]);
}
var V = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  ue = (e) => V.test(e);
function de(e, t = `/`) {
  ...
  return { pathname: a, search: ve(r), hash: ye(i) };
}
function fe(e, t) {
  ...
  typeof e == `string`
    ...
    : ((i = { ...e }),
      d(
        ...
        pe(`?`, `pathname`, `search`, i),
      ),
      d(
        !i.pathname || !i.pathname.includes(`#`),
        pe(`#`, `pathname`, `hash`, i),
      ),
      d(!i.search || !i.search.includes(`#`), pe(`#`, `search`, `hash`, i)));
  let a = e === `` || i.pathname === ``,
    o = a ? `/` : i.pathname,
    s;
  if (o == null) s = n;
...
function xe(e, t) {
  return new be(e, typeof t == `number` ? { status: t } : t);
}
var Se = (e, t = 302) => {
    let n = t;
    typeof n == `number`
...
function De(e, t) {
  ...
  if (
    ...
    let t = e.navigate[Te] ?? e.navigate,
      r = Oe(n.navigate, t, (...t) => {
        let [n, r] = t;
        return {
          to: typeof n == `number` || typeof n == `string` ? n : n ? g(n) : `.`,
          ...je(e, r ?? {}),
        };
      });
    r && ((r[Te] = t), (e.navigate = r));
  }
  if (n.fetch.length > 0) {
    let t = e.fetch[Te] ?? e.fetch,
      r = Oe(n.fetch, t, (...t) => {
        let [n, , r, i] = t;
...
var W = Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);
function G(e) {
  ...
  return (
    t === Object.prototype ||
    t === null ||
    Object.getOwnPropertyNames(t).sort().join(`\0`) === W
  );
}
var Pe = [`POST`, `PUT`, `PATCH`, `DELETE`],
  ...
  He = (e) => ({ hasErrorBoundary: !!e.hasErrorBoundary }),
  Ue = `remix-router-transitions`,
  We = Symbol(`ResetLoaderData`);
function Ge(e) {
  ...
  let r = e.hydrationRouteProperties || [],
    i = e.mapRouteProperties || He,
    a = i;
  if (e.unstable_instrumentations) {
    let t = e.unstable_instrumentations;
    a = (e) => ({ ...i(e), ...Ee(t.map((e) => e.route).filter(Boolean), e) });
  }
  let o = {},
    s = O(e.routes, a, void 0, o),
    c,
    l = e.basename || `/`;
  l.startsWith(`/`) || (l = `/${l}`);
  let u = e.dataStrategy || ct,
    ...
    C = A(s, e.history.location, l),
    w = !1,
    T = null,
    E;
  if (C == null && !e.patchRoutesOnNavigation) {
    let t = q(404, { pathname: e.history.location.pathname }),
      { matches: n, route: r } = kt(s);
    ((E = !0), (C = n), (T = { [r.id]: t }));
  } else if (
    (C &&
      !e.hydrationData &&
      st(C, s, e.history.location.pathname).active &&
      (C = null),
    C)
  )
    if (C.some((e) => e.route.lazy)) E = !1;
    else if (!C.some((e) => Xe(e.route))) E = !0;
    else {
      ...
      if (n) {
        ...
        E = C.slice(0, e + 1).every((e) => !Ze(e.route, t, n));
      } else E = C.every((e) => !Ze(e.route, t, n));
    }
  else {
    ((E = !1), (C = []));
  ...
  function me() {
    ...
    return (
      k.initialized || be(`POP`, k.location, { initialHydration: !0 }),
      D
    );
  }
  function he() {
    (m && m(),
      ...
      g.clear(),
      P && P.abort(),
      k.fetchers.forEach((e, t) => Ie(t)),
      k.blockers.forEach((e, t) => Qe(t)));
  }
  function ge(e) {
  ...
  function H(e, t = {}) {
    ...
    (k.fetchers.forEach((e, t) => {
      e.state === `idle` && (V.has(t) ? n.push(t) : r.push(t));
    }),
      V.forEach((e) => {
        !k.fetchers.has(e) && !L.has(e) && n.push(e);
      }),
      [...g].forEach((r) =>
        r(k, {
          deletedFetchers: n,
      ...
      n.forEach((e) => Ie(e)),
      r.forEach((e) => k.fetchers.delete(e)));
  }
  function _e(t, n, { flushSync: r } = {}) {
    let i =
        k.actionData != null &&
        k.navigation.formMethod != null &&
        Y(k.navigation.formMethod) &&
    ...
    a = n.actionData
      ...
      : i
        ...
        : null;
    let o = n.loaderData
        ? Et(k.loaderData, n.loaderData, n.matches || [], n.errors)
        : k.loaderData,
      l = k.blockers;
    l.size > 0 && ((l = new Map(l)), l.forEach((e, t) => l.set(t, Ve)));
    let u = re ? !1 : ot(t, n.matches || k.matches),
      d =
        te === !0 ||
        (k.navigation.formMethod != null &&
          Y(k.navigation.formMethod) &&
    ...
    ((c &&= ((s = c), void 0)),
      re ||
        ...
        (M === `PUSH`
          ...
          : M === `REPLACE` && e.history.replace(t, t.state)));
    let f;
    if (M === `POP`) {
      let e = ne.get(k.location.pathname);
      e && e.has(t.pathname)
        ? (f = { currentLocation: k.location, nextLocation: t })
        : ne.has(t.pathname) &&
          (f = { currentLocation: t, nextLocation: k.location });
    } else if (F) {
      let e = ne.get(k.location.pathname);
      (e
        ? e.add(t.pathname)
        : ((e = new Set([t.pathname])), ne.set(k.location.pathname, e)),
        (f = { currentLocation: k.location, nextLocation: t }));
    }
    (H(
      {
  ...
  async function ve(t, n) {
    ...
    let {
        ...
        !1,
        qe(k.location, k.matches, l, t, n?.fromRouteId, n?.relative),
        n,
      ),
      o = k.location,
      s = h(k.location, r, n && n.state);
    ...
    let d =
      ...
      f = (n && n.flushSync) === !0,
      p = et({ currentLocation: o, nextLocation: s, historyAction: u });
    if (p) {
      $e(p, {
        state: `blocked`,
        location: s,
  ...
  async function be(t, n, r) {
    ...
    let f = xt(e.history, n, P.signal, r && r.submission),
      p = e.getContext ? await e.getContext() : new S(),
      m;
    if (r && r.pendingError)
      m = [Ot(o).route.id, { type: `error`, error: r.pendingError }];
      ...
      if (t.pendingActionResult) {
        ...
        if (J(r) && Ce(r.error) && r.error.status === 404) {
          ((P = null),
            _e(n, {
              matches: t.matches,
              loaderData: {},
    ...
    h ||
      ((P = null),
      _e(n, { matches: g || o, ...Dt(m), loaderData: _, errors: v }));
  }
  async function xe(e, t, n, i, c, u, d, f = {}) {
    if (
      (Ne(), H({ navigation: Gt(t, n) }, { flushSync: f.flushSync === !0 }), u)
    ) {
      let n = await lt(i, t.pathname, e.signal);
      if (n.type === `aborted`) return { shortCircuited: !0 };
      if (n.type === `error`) {
        if (n.partialMatches.length === 0) {
          let { matches: e, route: t } = kt(s);
          return {
            matches: e,
            pendingActionResult: [t.id, { type: `error`, error: n.error }],
          };
        }
        let e = Ot(n.partialMatches).route.id;
        return {
        ...
        let { notFoundMatches: e, error: n, route: r } = nt(t.pathname);
        return {
          matches: e,
    ...
    if (!m.route.action && !m.route.lazy)
      ...
      let t = await je(e, mt(a, o, e, i, m, d ? [] : r, c), c, null);
      if (((p = t[m.route.id]), !p)) {
        for (let e of i)
          if (t[e.route.id]) {
            p = t[e.route.id];
    ...
    if (Lt(p)) {
      ...
      return (
        (t =
          f && f.replace != null
            ? f.replace
            : bt(p.response.headers.get(`Location`), new URL(e.url), l) ===
              k.location.pathname + k.location.search),
        await Ae(e, p, !0, { submission: n, replace: t }),
        { shortCircuited: !0 }
      );
    }
    if (J(p)) {
      let e = Ot(i, m.route.id);
      return (
        (f && f.replace) !== !0 && (M = `PUSH`),
        { matches: i, pendingActionResult: [e.route.id, p, m.route.id] }
      );
    }
    return { matches: i, pendingActionResult: [m.route.id, p] };
  }
  async function Se(t, n, i, u, d, f, p, m, h, g, _, v) {
    let y = f || Wt(n, p),
      b = p || m || Ut(y),
      x = !re && !g;
    if (d) {
      ...
      if (e.type === `error`) {
        if (e.partialMatches.length === 0) {
          let { matches: t, route: n } = kt(s);
          return { matches: t, loaderData: {}, errors: { [n.id]: e.error } };
        }
        let t = Ot(e.partialMatches).route.id;
        return {
    ...
    let S = c || s,
      { dsMatches: C, revalidatingFetchers: w } = Ye(
        t,
        u,
        a,
        o,
    ...
    if (x) {
      ...
      (w.length > 0 && (e.fetchers = we(w)), H(e, { flushSync: _ }));
    }
    w.forEach((e) => {
      (K(e.key), e.controller && L.set(e.key, e.controller));
    });
    let T = () => w.forEach((e) => K(e.key));
    P && P.signal.addEventListener(`abort`, T);
    let { loaderResults: E, fetcherResults: D } = await Me(C, w, t, u);
    if (t.signal.aborted) return { shortCircuited: !0 };
    (P && P.signal.removeEventListener(`abort`, T),
      w.forEach((e) => L.delete(e.key)));
    let O = At(E);
    if (O)
      return (
        await Ae(t, O.result, !0, { replace: h }),
        { shortCircuited: !0 }
      );
    if (((O = At(D)), O))
      return (
    ...
    let { loaderData: A, errors: j } = Tt(k, i, E, v, w, D);
    g && k.errors && (j = { ...k.errors, ...j });
    let ee = We(),
      M = Ge(se),
      N = ee || M || w.length > 0;
    return {
  ...
  async function Te(t, n, r, i) {
    ...
    let a = (i && i.flushSync) === !0,
      o = c || s,
      u = qe(k.location, k.matches, l, r, n, i?.relative),
      d = A(o, u, l),
      f = st(d, o, u);
    ...
    let { path: p, submission: m, error: h } = Je(!0, u, i);
    if (h) {
      G(t, n, h, { flushSync: a });
      return;
    }
    let g = e.getContext ? await e.getContext() : new S(),
      _ = (i && i.preventScrollReset) === !0;
    if (m && Y(m.formMethod)) {
      await Oe(t, n, p, d, g, f.active, a, _, m);
      return;
    }
    (ce.set(t, { routeId: n, path: p }),
      await ke(t, n, p, d, g, f.active, a, _, m));
  }
  async function Oe(t, n, i, u, f, p, m, h, g) {
    (Ne(), ce.delete(t), W(t, qt(g, k.fetchers.get(t)), { flushSync: m }));
    let _ = new AbortController(),
      v = xt(e.history, i, _.signal, g);
    if (p) {
      ...
      if (e.type === `error`) {
        ...
        G(t, n, q(404, { pathname: i }), { flushSync: m });
        return;
      }
    }
    let y = Ht(u, i);
    if (!y.route.action && !y.route.lazy) {
      G(t, n, q(405, { method: g.formMethod, pathname: i, routeId: n }), {
        flushSync: m,
      });
      return;
    }
      ...
      if (Lt(C))
        if ((L.delete(t), se > b)) {
          ...
          return (
            z.add(t),
            W(t, Kt(g)),
            Ae(v, C, !1, { fetcherSubmission: g, preventScrollReset: h })
          );
      if (J(C)) {
        G(t, n, C.error);
        return;
    ...
    let w = k.navigation.location || k.location,
      T = xt(e.history, w, _.signal),
      E = c || s,
      D =
        k.navigation.state === `idle`
          ? k.matches
          : A(E, k.navigation.location, l);
    d(D, `Didn't find any matches after fetcher action`);
    let O = ++oe;
    R.set(t, O);
    let j = Kt(g, C.data);
    k.fetchers.set(t, j);
    let { dsMatches: ee, revalidatingFetchers: N } = Ye(
      T,
      f,
      a,
      o,
    ...
    (N.filter((e) => e.key !== t).forEach((e) => {
      ...
      (k.fetchers.set(t, r), K(t), e.controller && L.set(t, e.controller));
    }),
      H({ fetchers: new Map(k.fetchers) }));
    let te = () => N.forEach((e) => K(e.key));
    _.signal.addEventListener(`abort`, te);
    let { loaderResults: F, fetcherResults: ne } = await Me(ee, N, T, f);
    if (_.signal.aborted) return;
    if (
      (_.signal.removeEventListener(`abort`, te),
      R.delete(t),
      L.delete(t),
      N.forEach((e) => L.delete(e.key)),
      k.fetchers.has(t))
    ) {
      let e = Jt(C.data);
      k.fetchers.set(t, e);
    ...
    let I = At(F);
    if (I) return Ae(T, I.result, !1, { preventScrollReset: h });
    if (((I = At(ne)), I))
      return (z.add(I.key), Ae(T, I.result, !1, { preventScrollReset: h }));
    let { loaderData: re, errors: B } = Tt(k, D, F, void 0, N, ne);
    (Ge(O),
      k.navigation.state === `loading` && O > se
        ? (d(M, `Expected pending action`),
          P && P.abort(),
          _e(k.navigation.location, {
            matches: D,
            loaderData: re,
            errors: B,
        ...
        : (H({
            errors: B,
            loaderData: Et(k.loaderData, re, D, B),
            fetchers: new Map(k.fetchers),
          }),
          (ie = !1)));
  }
  async function ke(t, n, i, s, c, l, u, d, f) {
    let p = k.fetchers.get(t);
    W(t, Kt(f, p ? p.data : void 0), { flushSync: u });
    let m = new AbortController(),
      h = xt(e.history, i, m.signal);
    if (l) {
      ...
      if (e.type === `error`) {
        ...
        G(t, n, q(404, { pathname: i }), { flushSync: u });
        return;
      }
    }
    let g = Ht(s, i);
    L.set(t, m);
    let _ = oe,
      v = (await je(h, mt(a, o, h, s, g, r, c), c, t))[g.route.id];
    if ((L.get(t) === m && L.delete(t), !h.signal.aborted)) {
      ...
      if (Lt(v))
        if (se > _) {
          ...
          (z.add(t), await Ae(h, v, !1, { preventScrollReset: d }));
          return;
        }
      if (J(v)) {
        G(t, n, v.error);
  ...
  async function Ae(
    ...
    (d(u, `Expected a Location header on the redirect Response`),
      (u = bt(u, new URL(e.url), l)));
    let f = h(k.location, u, { _isRedirect: !0 });
    if (n) {
      let e = !1;
    ...
    let p =
        c === !0 || r.response.headers.has(`X-Remix-Replace`)
          ? `REPLACE`
          : `PUSH`,
      { formMethod: m, formAction: g, formEncType: _ } = k.navigation;
    !a && !o && m && g && _ && (a = Ut(k.navigation));
    let v = a || o;
    Re.has(r.response.status) && v && Y(v.formMethod)
      ? await be(p, f, {
          submission: { ...v, formAction: u },
          preventScrollReset: s || te,
          enableViewTransition: i ? F : void 0,
        })
      : await be(p, f, {
          overrideNavigation: Wt(f, a),
          fetcherSubmission: o,
          preventScrollReset: s || te,
          enableViewTransition: i ? F : void 0,
        });
  ...
  async function je(e, t, n, r) {
    ...
    for (let [n, r] of Object.entries(i))
      if (It(r)) {
        let i = r.result;
        a[n] = { type: `redirect`, response: yt(i, e, n, t, l) };
      } else a[n] = await vt(r);
    return a;
  }
      ...
      a = Promise.all(
        t.map(async (e) => {
          if (e.matches && e.match && e.request && e.controller) {
            let t = (await je(e.request, e.matches, r, e.key))[
              e.match.route.id
            ];
            return { [e.key]: t };
          } else
  ...
  function G(e, t, n, r = {}) {
    let i = Ot(k.matches, t);
    (Ie(e),
      H(
        { errors: { [i.route.id]: n }, fetchers: new Map(k.fetchers) },
  ...
  function Fe(e, t) {
    (K(e, t?.reason), W(e, Jt(null)));
  }
  function Ie(e) {
    let t = k.fetchers.get(e);
    (L.has(e) && !(t && t.state === `loading` && R.has(e)) && K(e),
      ce.delete(e),
      R.delete(e),
      z.delete(e),
      V.delete(e),
  ...
  function Le(e) {
    let t = (le.get(e) || 0) - 1;
    (t <= 0 ? (le.delete(e), V.add(e)) : le.set(e, t),
      H({ fetchers: new Map(k.fetchers) }));
  }
  function K(e, t) {
    let n = L.get(e);
  ...
  function We() {
    ...
    for (let n of z) {
      ...
      (d(r, `Expected fetcher: ${n}`),
        r.state === `loading` && (z.delete(n), e.push(n), (t = !0)));
    }
    return (Ue(e), t);
  }
  function Ge(e) {
    ...
    for (let [n, r] of R)
      if (r < e) {
        ...
        (d(e, `Expected fetcher: ${n}`),
          e.state === `loading` && (K(n), R.delete(n), t.push(n)));
      }
    return (Ue(t), t.length > 0);
  }
  function Ke(e, t) {
    let n = k.blockers.get(e) || Ve;
    return (de.get(e) !== t && de.set(e, t), n);
  }
  function Qe(e) {
    (k.blockers.delete(e), de.delete(e));
  }
  function $e(e, t) {
    let n = k.blockers.get(e) || Ve;
    d(
  ...
  function et({ currentLocation: e, nextLocation: t, historyAction: n }) {
    if (de.size === 0) return;
    de.size > 1 && f(!1, `A router only supports one blocker at a time`);
  ...
  function nt(e) {
    let t = q(404, { pathname: e }),
      { matches: n, route: r } = kt(c || s);
    return { notFoundMatches: n, route: r, error: t };
  }
  function rt(e, t, n) {
    if (((_ = e), (b = t), (v = n || null), !x && k.navigation === ze)) {
      x = !0;
      let e = ot(k.location, k.matches);
    ...
    if (e.patchRoutesOnNavigation)
      if (t) {
        if (Object.keys(t[0].params).length > 0)
          return { active: !0, matches: j(n, r, l, !0) };
      } else return { active: !0, matches: j(n, r, l, !0) || [] };
...
function qe(e, t, n, r, i, a) {
  ...
  let c = ge(r || `.`, he(o), B(e.pathname, n) || e.pathname, a === `path`);
  if (
  ...
  return (
    n !== `/` && (c.pathname = le({ basename: n, pathname: c.pathname })),
    g(c)
  );
}
function Je(e, t, n) {
  if (!n || !Ke(n)) return { path: t };
  if (n.formMethod && !Bt(n.formMethod))
...
`,
  ...
  let o, s;
  if (n.formData) ((o = St(n.formData)), (s = n.formData));
  else if (n.body instanceof FormData) ((o = St(n.body)), (s = n.body));
  else if (n.body instanceof URLSearchParams) ((o = n.body), (s = Ct(o)));
  else if (n.body == null) ((o = new URLSearchParams()), (s = new FormData()));
  else
    try {
      ((o = new URLSearchParams(n.body)), (s = Ct(o)));
    } catch {
      return r();
    }
  let c = {
  ...
  let l = _(t);
  return (
    e && l.search && Vt(l.search) && o.append(`index`, ``),
    (l.search = `?${o}`),
    { path: g(l), submission: c }
  );
}
function Ye(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _, v, y) {
  ...
  let w = y ? y[1].statusCode : void 0,
    ...
    O = o.map((i, o) => {
      ...
      if (
        (C != null && o > C
          ...
          : s.lazy
            ...
            : Xe(s)
              ? u
                ? (c = Ze(s, a.loaderData, a.errors))
                : Qe(a.loaderData, a.matches[o], i) && (c = !0)
              : (c = !1),
        c !== null)
      )
        return pt(n, r, e, D, i, l, t, c);
      let f = T
          ? !1
          : d ||
      ...
      return pt(n, r, e, D, i, l, t, et(i, p), p);
    }),
    k = [];
  return (
    m.forEach((e, s) => {
      ...
      let b = Ht(y, e.path),
        ...
        S = xt(i, e.path, x.signal),
        C = null;
      if (f.has(s)) (f.delete(s), (C = mt(n, r, S, y, b, l, t)));
      else if (m) d && (C = mt(n, r, S, y, b, l, t));
      else {
        let e = { ...E, defaultShouldRevalidate: T ? !1 : d };
        et(b, e) && (C = mt(n, r, S, y, b, l, t, e));
      }
      C &&
        k.push({
          key: s,
...
function tt(e, t, n, r, i, a) {
  ...
  if (
    (t.forEach((e) => {
      let t = o.find((t) => nt(e, t));
      t ? c.push({ existingRoute: t, newRoute: e }) : s.push(e);
    }),
    s.length > 0)
  ) {
    let t = O(s, i, [e || `_`, `patch`, String(o?.length || `0`)], r);
    o.push(...t);
  }
  if (a && c.length > 0)
  ...
  return `id` in e && `id` in t && e.id === t.id
    ...
    : e.index === t.index &&
      ...
      ? (!e.children || e.children.length === 0) &&
        ...
        ? !0
        : e.children.every((e, n) => t.children?.some((t) => nt(e, t)))
      : !1;
}
var rt = new WeakMap(),
  it = ({ key: e, route: t, manifest: n, mapRouteProperties: r }) => {
    let i = n[t.id];
    if (
      (d(i, `No route found in manifest`), !i.lazy || typeof i.lazy != `object`)
    )
      return;
    let a = i.lazy[e];
    if (!a) return;
...
function ot(e, t, n, r, i) {
  ...
  for (let a of o) {
    ...
    let o = it({ key: a, route: e, manifest: n, mapRouteProperties: r });
    o && (s.push(o), a === t && (c = o));
  }
...
async function ct(e) {
  return e.matches.some((e) => e.route.middleware) ? lt(e, () => st(e)) : st(e);
}
function lt(e, t) {
  return ut(e, t, (e) => e, Pt, n);
  function n(t, n, r) {
    if (r)
      return Promise.resolve(
...
async function dt(e, t, n, r, i, a, o = 0) {
  let { request: s } = e;
  if (s.signal.aborted)
  ...
  let [l, u] = c,
    ...
    f = async () => {
      ...
      try {
        return ((d = { value: await dt(e, t, n, r, i, a, o + 1) }), d.value);
      } catch (e) {
...
function ft(e, t, n, r, i) {
  let a = it({
    ...
    o = ot(r.route, Y(n.method) ? `action` : `loader`, t, e, i);
  return {
    middleware: a,
...
function pt(e, t, n, r, i, a, o, s, c = null) {
  let l = !1,
    u = ft(e, t, n, i, a);
  return {
    ...i,
    ...
    shouldCallHandler(e) {
      return (
        ...
        c
          ? typeof e == `boolean`
            ? et(i, { ...c, defaultShouldRevalidate: e })
            : et(i, c)
          : s
      );
    },
    resolve(e) {
      let { lazy: t, loader: a, middleware: c } = i.route,
        d = l || s || (e && !Y(n.method) && (t || a)),
        f = c && c.length > 0 && !a && !t;
      return d && (Y(n.method) || !f)
        ? gt({
            request: n,
            unstable_pattern: r,
            match: i,
...
function mt(e, t, n, r, i, a, o, s = null) {
  return r.map((c) =>
    c.route.id === i.route.id
      ? pt(e, t, n, we(r), c, a, o, !0, s)
      : {
          ...c,
          shouldLoad: !1,
          shouldRevalidateArgs: s,
          shouldCallHandler: () => !1,
          _lazyPromises: ft(e, t, n, c, a),
    ...
    if (r || i)
      if (t) {
        ...
        if (t) [s] = await Promise.all([d(t), i]);
          ...
          throw q(405, { method: e.method, pathname: r, routeId: n.route.id });
...
async function vt(e) {
  ...
  return n === `error`
    ? Rt(t)
      ...
      : { type: `error`, error: t, statusCode: Ce(t) ? t.status : void 0 }
    : Rt(t)
      ? {
          type: `data`,
          data: t.data,
...
function yt(e, t, n, r, i) {
  ...
  if (
    ...
    ((a = qe(new URL(t.url), o, i, a)), e.headers.set(`Location`, a));
  }
  return e;
}
function bt(e, t, n) {
  ...
  return (
    e.forEach((n) => {
      ...
      let f = n.route.id,
        p = t[f];
      if (
        (d(!Lt(p), `Cannot handle redirect results in processLoaderData`), J(p))
      ) {
        let t = p.error;
        if ((u !== void 0 && ((t = u), (u = void 0)), (o ||= {}), i)) o[f] = t;
        else {
          let n = Ot(e, f);
          o[n.route.id] ?? (o[n.route.id] = t);
        }
        (r || (a[f] = We),
          c || ((c = !0), (s = Ce(p.error) ? p.error.status : 500)),
  ...
  return (
    i
      ...
      .forEach((t) => {
        ...
        let o = a[n];
        if ((d(o, `Did not find corresponding fetcher result`), J(o))) {
          let t = Ot(e.matches, r?.route.id);
          ((s && s[t.route.id]) || (s = { ...s, [t.route.id]: o.error }),
            e.fetchers.delete(n));
        } else if (Lt(o)) d(!1, `Unhandled fetcher revalidation redirect`);
        else {
          let t = Jt(o.data);
          e.fetchers.set(n, t);
        }
...
function At(e) {
  ...
  for (let e = t.length - 1; e >= 0; e--) {
    let [n, r] = t[e];
    if (Lt(r)) return { key: n, result: r };
  }
}
function jt(e) {
  return g({ ...(typeof e == `string` ? _(e) : e), hash: `` });
}
function Mt(e, t) {
...
function Pt(e) {
  return (
    typeof e == `object` &&
    !!e &&
    Object.entries(e).every(([e, t]) => typeof e == `string` && Ft(t))
  );
}
function Ft(e) {
  return (
...
function It(e) {
  return zt(e.result) && K.has(e.result.status);
}
function J(e) {
  return e.type === `error`;
}
...
function Y(e) {
  return Fe.has(e.toUpperCase());
}
function Vt(e) {
  return new URLSearchParams(e).getAll(`index`).some((e) => e === ``);
}
function Ht(e, t) {
  let n = typeof t == `string` ? _(t).search : t.search;
  if (e[e.length - 1].route.index && Vt(n || ``)) return e[e.length - 1];
  let r = me(e);
  return r[r.length - 1];
}
function Ut(e) {
...
function Xt(e, t) {
  if (t.size > 0) {
    ...
    try {
      e.sessionStorage.setItem(Ue, JSON.stringify(n));
    } catch (e) {
      f(
        !1,
...
var Qt = i.createContext(null);
Qt.displayName = `DataRouter`;
var $t = i.createContext(null);
$t.displayName = `DataRouterState`;
var en = i.createContext(!1);
function tn() {
  return i.useContext(en);
}
var nn = i.createContext({ isTransitioning: !1 });
nn.displayName = `ViewTransition`;
var rn = i.createContext(new Map());
rn.displayName = `Fetchers`;
var an = i.createContext(null);
an.displayName = `Await`;
var X = i.createContext(null);
X.displayName = `Navigation`;
var on = i.createContext(null);
on.displayName = `Location`;
var Z = i.createContext({ outlet: null, matches: [], isDataRoute: !1 });
Z.displayName = `Route`;
var sn = i.createContext(null);
sn.displayName = `RouteError`;
function cn(e, { relative: t } = {}) {
  d(ln(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = i.useContext(X),
    { hash: a, pathname: o, search: s } = _n(e, { relative: t }),
    c = o;
  return (
    n !== `/` && (c = o === `/` ? n : H([n, o])),
    r.createHref({ pathname: c, search: s, hash: a })
  );
}
function ln() {
  return i.useContext(on) != null;
}
function Q() {
  return (
    d(
...
function fn() {
  let { isDataRoute: e } = i.useContext(Z);
  return e ? Fn() : pn();
}
function pn() {
  d(
  ...
  let e = i.useContext(Qt),
    { basename: t, navigator: n } = i.useContext(X),
    { matches: r } = i.useContext(Z),
    { pathname: a } = Q(),
    o = JSON.stringify(he(r)),
    s = i.useRef(!1);
  return (
    dn(() => {
      s.current = !0;
    ...
    i.useCallback(
      (r, i = {}) => {
        if ((f(s.current, un), !s.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
        let c = ge(r, JSON.parse(o), a, i.relative === `path`);
        (e == null &&
          t !== `/` &&
          (c.pathname = c.pathname === `/` ? t : H([t, c.pathname])),
          (i.replace ? n.replace : n.push)(c, i.state, i));
      },
      [t, n, o, a, e],
    )
  );
}
var mn = i.createContext(null);
function hn(e) {
  let t = i.useContext(Z).outlet;
  return i.useMemo(
    () => t && i.createElement(mn.Provider, { value: e }, t),
    [t, e],
  );
}
function gn() {
  let { matches: e } = i.useContext(Z),
    t = e[e.length - 1];
  return t ? t.params : {};
}
function _n(e, { relative: t } = {}) {
  let { matches: n } = i.useContext(Z),
    { pathname: r } = Q(),
    a = JSON.stringify(he(n));
  return i.useMemo(() => ge(e, JSON.parse(a), r, t === `path`), [e, a, r, t]);
}
function vn(e, t, n, r, a) {
  ...
  let { navigator: o } = i.useContext(X),
    { matches: s } = i.useContext(Z),
    c = s[s.length - 1],
    l = c ? c.params : {},
    u = c ? c.pathname : `/`,
    p = c ? c.pathnameBase : `/`,
...
var bn = i.createElement(yn, null),
  xn = class extends i.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
...
function Sn({ routeContext: e, match: t, children: n }) {
  let r = i.useContext(Qt);
  return (
    r &&
      r.static &&
      r.staticContext &&
    ...
    i.createElement(Z.Provider, { value: e }, n)
  );
}
function Cn(e, t = [], n = null, r = null, a = null) {
  if (e == null) {
    if (!n) return null;
  ...
  if (n)
    for (let e = 0; e < o.length; e++) {
      let t = o[e];
      if (
        ((t.route.HydrateFallback || t.route.hydrateFallbackElement) && (l = e),
        t.route.id)
      ) {
    ...
    let h = t.concat(o.slice(0, a + 1)),
      g = () => {
        ...
        return (
          ...
          i.createElement(Sn, {
            match: r,
            routeContext: { outlet: e, matches: h, isDataRoute: n != null },
            children: t,
          })
        );
      };
    return n && (r.route.ErrorBoundary || r.route.errorElement || a === 0)
      ? i.createElement(xn, {
          location: n.location,
...
function An() {
  return En(`useNavigation`).navigation;
}
function jn() {
  let { matches: e, loaderData: t } = En(`useMatches`);
  return i.useMemo(() => e.map((e) => ee(e, t)), [e, t]);
}
function Mn() {
  let e = En(`useLoaderData`),
    t = On(`useLoaderData`);
  return e.loaderData[t];
}
function Nn() {
  let e = En(`useActionData`),
    t = On(`useLoaderData`);
  return e.actionData ? e.actionData[t] : void 0;
}
function Pn() {
  let e = i.useContext(sn),
    t = En(`useRouteError`),
    n = On(`useRouteError`);
  return e === void 0 ? t.errors?.[n] : e;
}
function Fn() {
  let { router: e } = Tn(`useNavigate`),
    t = On(`useNavigate`),
    n = i.useRef(!1);
  return (
    dn(() => {
...
var Wn = [`HydrateFallback`, `hydrateFallbackElement`],
  Gn = class {
    constructor() {
      ((this.status = `pending`),
...
function Kn({
  ...
  let [a, o] = i.useState(e.state),
    [s, c] = Hn(a),
    [l, u] = i.useState(),
    [d, f] = i.useState({ isTransitioning: !1 }),
    [p, m] = i.useState(),
    [h, g] = i.useState(),
    [_, v] = i.useState(),
    y = i.useRef(new Map()),
    b = i.useCallback(
      ...
      [e.window, t, h, p, r, c, n],
    );
  (i.useLayoutEffect(() => e.subscribe(b), [e, b]),
    i.useEffect(() => {
      d.isTransitioning && !d.flushSync && m(new Gn());
    }, [d]),
    i.useEffect(() => {
      if (p && l && e.window) {
        let t = l,
...
var Jn = i.memo(Yn);
function Yn({ routes: e, future: t, state: n, unstable_onError: r }) {
  return vn(e, void 0, n, r, t);
}
function Xn(e) {
  return hn(e.context);
}
  ...
  let {
    ...
    v = i.useMemo(() => {
      ...
      return e == null
        ? null
        : {
            location: { pathname: e, search: p, hash: m, state: h, key: g },
            navigationType: r,
          };
    }, [c, u, p, m, h, g, r]);
  return (
    f(
      v != null,
      `<Router basename="${c}"> is not able to match the URL "${u}${p}${m}" because it does not start with the basename, so the <Router> won't render anything.`,
    ),
    v == null
      ? null
      : i.createElement(
          X.Provider,
          { value: l },
          i.createElement(on.Provider, { children: t, value: v }),
        )
  );
}
function Qn() {
  return { params: gn(), loaderData: Mn(), actionData: Nn(), matches: jn() };
}
function $n(e) {
  return function () {
    let t = Qn();
...
function pr(e) {
  return e != null && !fr.has(e)
    ? (f(
        !1,
        `"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${tr}"`,
      ),
      null)
    : e;
}
function mr(e, t) {
  ...
  if (ir(e)) {
    ...
    ((r = o ? B(o, t) : null),
      (n = e.getAttribute(`method`) || er),
      (i = pr(e.getAttribute(`enctype`)) || tr),
      (a = new FormData(e)));
  } else if (rr(e) || (ar(e) && (e.type === `submit` || e.type === `image`))) {
    let o = e.form;
    if (o == null)
      throw Error(
    ...
    if (
      ((r = s ? B(s, t) : null),
      (n = e.getAttribute(`formmethod`) || o.getAttribute(`method`) || er),
      (i =
        pr(e.getAttribute(`formenctype`)) ||
        pr(o.getAttribute(`enctype`)) ||
        tr),
      (a = new FormData(o, e)),
      !dr())
    ) {
...
function Ir(e) {
  ...
  if (typeof e == `number`) return Lr.call(this, e);
  if (!Array.isArray(e) || !e.length) throw SyntaxError();
  let r = n.length;
  for (let t of e) n.push(t);
  return ((t.length = n.length), Lr.call(this, r));
}
function Lr(e) {
    ...
    if (Array.isArray(c))
      if (typeof c[0] == `string`) {
        ...
        switch (n) {
          ...
          case wr:
            let [, p, m] = c,
              h = m && Fr && Fr[m] ? new Fr[m](p) : Error(p);
            ((t[e] = h), a(h));
            continue;
          case Mr:
            a((t[e] = t[l]));
...
async function zr(e) {
  ...
  return { done: t.done, value: Ir.call(this, n) };
}
async function Br(e) {
  let t = await e.read();
  for (; !t.done; ) {
...
var Hr = {
  ...
  Ur = /[&><\u2028\u2029]/g;
function Wr(e) {
  return e.replace(Ur, (e) => Hr[e]);
}
function $(e, t) {
  if (e === !1 || e == null) throw Error(t);
}
var Gr = Symbol(`SingleFetchRedirect`),
  Kr = class extends Error {},
  qr = new Set([100, 101, 204, 205]);
function Jr(e, t, n, r, i) {
  ...
  return async (e) => e.runClientMiddleware(a);
}
function Yr(e, t, n, r, i, a = () => !0) {
  return async (o) => {
    let { request: s, matches: c, fetcherKey: l } = o,
      u = e();
    if (s.method !== `GET`) return Xr(o, n, i);
    let d = c.some((e) => {
...
async function Xr(e, t, n) {
  let r = e.matches.find((e) => e.shouldCallHandler());
    ...
    a = await r.resolve(
      async (a) =>
        await a(async () => {
          ...
          return ((i = o), ai(a, r.route.id));
        }),
    );
  return zt(a.result) || Ce(a.result) || Rt(a.result)
    ? { [r.route.id]: a }
    : { [r.route.id]: { type: a.type, result: xe(a.result, i) } };
}
async function Zr(e, t, n, r) {
  let i = e.matches.filter((e) => e.shouldCallHandler()),
    a = {};
  return (
    await Promise.all(
      i.map((i) =>
...
async function Qr(e, t, n, r, i, a, o = () => !0) {
  let s = new Set(),
    c = !1,
    l = e.matches.map(() => oi()),
    u = oi(),
    ...
    f = Promise.all(
      e.matches.map(async (t, i) =>
        t.resolve(async (f) => {
          l[i].resolve();
          let p = t.route.id,
            { hasLoader: m, hasClientLoader: h, hasShouldRevalidate: g } = n(t),
            _ =
          ...
          if (!t.shouldCallHandler(_)) {
            c ||= t.shouldRevalidateArgs != null && m && g === !0;
            return;
          }
          if (o(t) && h) {
            m && (c = !0);
            try {
              d[p] = {
                type: `data`,
                result: await f(async () => {
                  let { data: t } = await r(e, a, [p]);
                  return ai(t, p);
                }),
              };
            } catch (e) {
              d[p] = { type: `error`, result: e };
            }
            return;
          }
          m && s.add(p);
          try {
            d[p] = {
              type: `data`,
              result: await f(async () => ai(await u.promise, p)),
            };
          } catch (e) {
            d[p] = { type: `error`, result: e };
          }
  ...
  if (
    (await Promise.all(l.map((e) => e.promise)),
    ...
    let t = i && c && s.size > 0 ? [...s.keys()] : void 0;
    try {
      let n = await r(e, a, t);
      u.resolve(n.data);
    } catch (e) {
  ...
  return (await f, await $r(u.promise, e.matches, s, d), d);
}
  ...
  try {
    ...
    i !== void 0 &&
      Array.from(n.values()).forEach((e) => {
        r[e].result instanceof Kr && (r[e].result = i);
      });
  } catch {}
}
...
async function ri(e, t, n) {
  let { request: r } = e,
    i = ni(r.url, t, `data`);
  r.method === `GET` &&
    ((i = ti(i)), n && i.searchParams.set(`_routes`, n.join(`,`)));
  let a = await fetch(i, await Vr(r));
  if (a.status >= 400 && !a.headers.has(`X-Remix-Response`))
    throw new U(a.status, a.statusText, await a.text());
  ...
  try {
    let e = await ii(a.body, window),
      t;
    if (r.method === `GET`) {
      let n = e.value;
      t = Gr in n ? { redirect: n[Gr] } : { routes: n };
    } else {
      let r = e.value,
        i = n?.[0];
  ...
  return Rr(e, {
    plugins: [
      (e, ...n) => {
        ...
        if (e === `SingleFetchRedirect`) return { value: { [Gr]: n[0] } };
...
function ai(e, t) {
  ...
  let n = e.routes[t];
  if (n == null) throw new Kr(`No result found for routeId "${t}"`);
...
async function ui(e) {
  if (!e.css) return;
  let t = li(e);
  await Promise.all(t.map(fi));
}
async function di(e, t) {
  if ((!e.css && !t.links) || !Si()) return;
  let n = [];
  if (
    (e.css && n.push(...li(e)), t.links && n.push(...t.links()), n.length === 0)
  )
    return;
  let r = [];
  for (let e of n)
...
function _i(e, t, { includeHydrateFallback: n } = {}) {
  return vi(
    e
      .map((e) => {
        let r = t.routes[e.route.id];
...
function Si() {
  ...
  return ((xi = e.relList.supports(`preload`)), (e = null), xi);
}
function Ci() {
  return i.createElement(
    ha,
...
function Ti(e, t, n) {
  ...
  return e.id === `root` && t.Layout
    ? {
        ...
        ...(a
          ? {
              hydrateFallbackElement: i.createElement(
                t.Layout,
                null,
    ...
    : { Component: r, ErrorBoundary: o, HydrateFallback: a };
}
function Ei(e, t, n, r, i, a) {
  return ki(t, n, r, i, a, ``, wi(t), e);
}
function Di(e, t) {
...
function ki(e, t, n, r, i, a = ``, o = wi(e), s) {
  return (o[a] || []).map((a) => {
    let c = t[a.id];
    function l(e) {
      return (
    ...
    function d(e) {
      if (!a.hasAction) throw Oi(`action`, a.id);
      return l(e);
    }
    function f(e) {
      import(e);
    ...
    let h = { id: a.id, index: a.index, path: a.path };
    if (c) {
      Object.assign(h, {
        ...h,
        ...Ti(a, c, i),
        middleware: c.clientMiddleware,
        handle: c.handle,
        shouldRevalidate: Ai(h.path, c, a, r, s),
      });
      ...
      ((h.loader = async (
        { request: n, params: r, context: i, unstable_pattern: s },
        d,
      ) => {
        try {
          return await m(
        ...
        (h.loader.hydrate = Pi(a.id, c.clientLoader, a.hasLoader, i)),
        (h.action = (
          { request: e, params: t, context: n, unstable_pattern: r },
          o,
        ) =>
          m(async () => {
            if (
              ...
              if (i) throw Oi(`clientAction`, a.id);
              return d(o);
            }
            return c.clientAction({
              ...
              unstable_pattern: r,
              async serverAction() {
                return (Di(`action`, a), d(o));
              },
            });
          })));
    } else {
      (a.hasClientLoader || (h.loader = (e, t) => m(() => u(t))),
        a.hasClientAction ||
          (h.action = (e, t) =>
            m(() => {
              if (i) throw Oi(`clientAction`, a.id);
      ...
      h.lazy = {
        loader: a.hasClientLoader
          ? async () => {
              let { clientLoader: e } = a.clientLoaderModule
                ? await import(a.clientLoaderModule)
                : await n();
              return (
        ...
        action: a.hasClientAction
          ? async () => {
              let e = a.clientActionModule ? import(a.clientActionModule) : n();
              p(a);
        ...
        middleware: a.hasClientMiddleware
          ? async () => {
              let { clientMiddleware: e } = a.clientMiddlewareModule
                ? await import(a.clientMiddlewareModule)
                : await n();
    ...
    let g = ki(e, t, n, r, i, a.id, o, s);
    return (g.length > 0 && (h.children = g), h);
  });
}
function Ai(e, t, n, r, i) {
  if (i) return ji(n.id, t.shouldRevalidate, i);
  if (!r && n.hasLoader && !n.hasClientLoader) {
    let n = e ? z(e)[1].map((e) => e.paramName) : [],
...
function Hi(e, t, n, r, a, o) {
  i.useEffect(() => {
    if (!zi(a, r) || window.navigator?.connection?.saveData === !0) return;
    function i(e) {
      let t =
        e.tagName === `FORM`
    ...
    async function s() {
      document
        ...
        .forEach(i);
      let s = Array.from(Fi.keys()).filter((e) =>
        Li.has(e) ? (Fi.delete(e), !1) : !0,
      );
      if (s.length !== 0)
        try {
          await Gi(
...
var Wi = `react-router-manifest-version`;
async function Gi(e, t, n, r, i, a, o, s, c, l) {
  let u = new URLSearchParams();
  (u.set(`paths`, e.sort().join(`,`)), u.set(`version`, n.version));
  let d = new URL(Ui(s, o), window.location.origin);
  if (((d.search = u.toString()), d.toString().length > Ri)) {
    Fi.clear();
    return;
  }
  let f;
  try {
    ...
    if (e.ok) {
      if (e.status === 204 && e.headers.has(`X-Remix-Reload-Document`)) {
        ...
        try {
          if (sessionStorage.getItem(Wi) === n.version) {
            console.error(
              `Unable to discover routes due to manifest version mismatch.`,
            );
            return;
          }
          sessionStorage.setItem(Wi, n.version);
        } catch {}
  ...
  (Object.assign(n.routes, m), e.forEach((e) => Ki(e, Li)));
  let h = new Set();
  (Object.values(m).forEach((e) => {
    e && (!e.parentId || !m[e.parentId]) && h.add(e.parentId);
  }),
    h.forEach((e) => c(e || null, ki(m, r, null, i, a, e))));
}
function Ki(e, t) {
  if (t.size >= Ii) {
...
var Xi = i.createContext(void 0);
Xi.displayName = `FrameworkContext`;
function Zi() {
  let e = i.useContext(Xi);
  return (
...
var ta = `data-react-router-critical-css`;
function na({ nonce: e }) {
  let { isSpaMode: t, manifest: n, routeModules: r, criticalCss: a } = Zi(),
    { errors: o, matches: s } = Yi(),
    c = ea(s, o, t),
    l = i.useMemo(() => ci(c, r, n), [c, r, n]);
  return i.createElement(
    i.Fragment,
    null,
    typeof a == `string`
    ...
    l.map(({ key: t, link: n }) =>
      pi(n)
        ? i.createElement(ra, { key: t, nonce: e, ...n })
        : i.createElement(`link`, { key: t, nonce: e, ...n }),
    ),
  );
}
function ra({ page: e, ...t }) {
  let { router: n } = Ji(),
    r = i.useMemo(() => A(n.routes, e, n.basename), [n.routes, e, n.basename]);
  return r ? i.createElement(aa, { page: e, matches: r, ...t }) : null;
}
function ia(e) {
  let { manifest: t, routeModules: n } = Zi(),
    [r, a] = i.useState([]);
  return (
    i.useEffect(() => {
      let r = !1;
...
function aa({ page: e, matches: t, ...n }) {
  let r = Q(),
    { manifest: a, routeModules: o } = Zi(),
    { basename: s } = Ji(),
    { loaderData: c, matches: l } = Yi(),
    u = i.useMemo(() => gi(e, t, l, a, r, `data`), [e, t, l, a, r]),
    d = i.useMemo(() => gi(e, t, l, a, r, `assets`), [e, t, l, a, r]),
    f = i.useMemo(() => {
  ...
  return i.createElement(
    ...
    m.map(({ key: e, link: t }) =>
      i.createElement(`link`, { key: e, nonce: n.nonce, ...t }),
    ),
  );
}
function oa() {
  let { isSpaMode: e, routeModules: t } = Zi(),
    { errors: n, matches: r, loaderData: a } = Yi(),
    o = Q(),
    s = ea(r, n, e),
    c = null;
  n && (c = n[s[s.length - 1].route.id]);
  let l = [],
    u = null,
    d = [];
  ...
  return i.createElement(
    ...
    l.flat().map((e) => {
      ...
      if (`tagName` in e) {
        ...
        let r = t;
        return i.createElement(r, { key: JSON.stringify(n), ...n });
      }
      if (`title` in e)
        return i.createElement(`title`, { key: `title` }, String(e.title));
      if (
        (`charset` in e && ((e.charSet ??= e.charset), delete e.charset),
        `charSet` in e && e.charSet != null)
      )
        return typeof e.charSet == `string`
          ? i.createElement(`meta`, { key: `charSet`, charSet: e.charSet })
          : null;
      if (`script:ld+json` in e)
        try {
          ...
          return i.createElement(`script`, {
            ...
            dangerouslySetInnerHTML: { __html: Wr(t) },
          });
        } catch {
          return null;
        }
      return i.createElement(`meta`, { key: JSON.stringify(e), ...e });
    }),
  );
}
function sa(e) {
...
function ua(e) {
  let {
    ...
    { router: c, static: l, staticContext: u } = Ji(),
    { matches: d } = Yi(),
    f = tn(),
    p = zi(o, s);
...
import(${JSON.stringify(t.entry.module)});`
    ...
    g =
      ca || f
        ? []
        : da(t.entry.imports.concat(_i(m, t, { includeHydrateFallback: !0 }))),
...
var pa = class extends i.Component {
  constructor(e) {
  ...
  render() {
    return this.state.error
      ? i.createElement(ma, { error: this.state.error, isOutsideRemixApp: !0 })
      : this.props.children;
  }
};
function ma({ error: e, isOutsideRemixApp: t }) {
  console.error(e);
  ...
  return i.createElement(
    ...
    i.createElement(`h1`, { style: { fontSize: `24px` } }, `Application Error`),
    i.createElement(
      `pre`,
      {
        style: {
...
function ha({ title: e, renderScripts: t, isOutsideRemixApp: n, children: r }) {
  let { routeModules: a } = Zi();
    ...
    : i.createElement(
        ...
        i.createElement(
          ...
          i.createElement(
            ...
            r,
            t ? i.createElement(ua, null) : null,
          ),
        ),
      );
}
...
try {
  ga && (window.__reactRouterVersion = `7.10.1`);
} catch {}
function _a({
  basename: e,
  children: t,
  ...
  let [a, o] = i.useState({ action: n.action, location: n.location }),
    s = i.useCallback(
      (e) => {
        r === !1 ? o(e) : i.startTransition(() => o(e));
      },
      [r],
    );
  return (
    i.useLayoutEffect(() => n.listen(s), [n, s]),
    i.createElement(Zn, {
      basename: e,
      children: t,
      location: a.location,
...
_a.displayName = `unstable_HistoryRouter`;
var va = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  ya = i.forwardRef(function (
    {
      onClick: e,
      discover: t = `render`,
      prefetch: n = `none`,
    ...
    let { basename: h, unstable_useTransitions: g } = i.useContext(X),
      _ = typeof l == `string` && va.test(l),
      v,
      y = !1;
    if (typeof l == `string` && _ && ((v = l), ga))
      try {
        let e = new URL(window.location.href),
          t = l.startsWith(`//`) ? new URL(e.protocol + l) : new URL(l),
          n = B(t.pathname, h);
    ...
    return x && !_
      ? i.createElement(i.Fragment, null, E, i.createElement(ra, { page: b }))
      : E;
  });
ya.displayName = `Link`;
var ba = i.forwardRef(function (
  {
    "aria-current": e = `page`,
    caseSensitive: t = !1,
    className: n = ``,
  ...
  let d = _n(o, { relative: l.relative }),
    f = Q(),
    p = i.useContext($t),
    { navigator: m, basename: h } = i.useContext(X),
    g = p != null && La(d) && s === !0,
...
var xa = i.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = i.useContext(X),
      g = Aa(),
      _ = ja(c, { relative: u }),
      v = s.toLowerCase() === `get` ? `get` : `post`,
      y = typeof c == `string` && va.test(c);
...
xa.displayName = `Form`;
function Sa({ getKey: e, storageKey: t, ...n }) {
  let r = i.useContext(Xi),
    { basename: a } = i.useContext(X),
    o = Q(),
    s = jn();
  Fa({ getKey: e, storageKey: t });
  let c = i.useMemo(() => {
    if (!r || !e) return null;
    let t = Pa(o, s, a, e);
  ...
  return i.createElement(`script`, {
    ...
    suppressHydrationWarning: !0,
    dangerouslySetInnerHTML: {
      __html: `(${l})(${JSON.stringify(t || Ma)}, ${JSON.stringify(c)})`,
    },
  });
}
Sa.displayName = `ScrollRestoration`;
function Ca(e) {
  return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`;
}
function wa(e) {
...
function Da(e) {
  ...
  let t = i.useRef(cr(e)),
    n = i.useRef(!1),
    r = Q(),
    a = i.useMemo(() => lr(r.search, n.current ? null : t.current), [r.search]),
    o = fn();
  return [
    a,
    i.useCallback(
      (e, t) => {
        let r = cr(typeof e == `function` ? e(new URLSearchParams(a)) : e);
        ((n.current = !0), o(`?` + r, t));
      },
      [o, a],
    ),
...
function Aa() {
  ...
  return i.useCallback(
    async (e, i = {}) => {
      let { action: o, method: s, encType: c, formData: l, body: u } = mr(e, t);
      i.navigate === !1
        ? await r(i.fetcherKey || ka(), n, i.action || o, {
...
function ja(e, { relative: t } = {}) {
  ...
  return (
    ...
    n !== `/` && (o.pathname = o.pathname === `/` ? n : H([n, o.pathname])),
    g(o)
  );
}
var Ma = `react-router-scroll-positions`,
  Na = {};
function Pa(e, t, n, r) {
  let i = null;
  return (
    r &&
      (i = r(
        n === `/` ? e : { ...e, pathname: B(e.pathname, n) || e.pathname },
        t,
      )),
    (i ??= e.key),
    i
...
function Fa({ getKey: e, storageKey: t } = {}) {
  let { router: n } = wa(`useScrollRestoration`),
    { restoreScrollPosition: r, preventScrollReset: a } =
      Ta(`useScrollRestoration`),
    { basename: o } = i.useContext(X),
    s = Q(),
    c = jn(),
    l = An();
  (i.useEffect(
    ...
    Ia(
      i.useCallback(() => {
        ...
        try {
          sessionStorage.setItem(t || Ma, JSON.stringify(Na));
        } catch (e) {
          f(
            !1,
    ...
    typeof document < `u` &&
      (i.useLayoutEffect(() => {
        try {
          let e = sessionStorage.getItem(t || Ma);
          e && (Na = JSON.parse(e));
        } catch {}
      }, [t]),
      i.useLayoutEffect(() => {
...
function La(e, { relative: t } = {}) {
  let n = i.useContext(nn);
  d(
    n != null,
    "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?",
  );
  let { basename: r } = wa(`useViewTransitionState`),
    a = _n(e, { relative: t });
  if (!n.isTransitioning) return !1;
  let o = B(n.currentLocation.pathname, r) || n.currentLocation.pathname,
    s = B(n.nextLocation.pathname, r) || n.nextLocation.pathname;
